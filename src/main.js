    ...
    const slides = [
      {
        ...
        overlay: "CARRO CHEFE",
        images: [
          new URL("./assets/img-principal-menu1.webp", import.meta.url).href,
          new URL("./assets/img2-menu1.webp", import.meta.url).href,
          new URL("./assets/img3-menu1.webp", import.meta.url).href,
          new URL("./assets/img4-primeiro-menu.webp", import.meta.url).href,
        ],
      },
      {
        id: 2,
        ...
        overlay: "NA BRASA",
        images: [
          new URL("./assets/img-principal-churrasco.webp", import.meta.url)
            .href,
          new URL("./assets/img-churrasco1.webp", import.meta.url).href,
          new URL("./assets/img-churrasco-3.webp", import.meta.url).href,
          new URL("./assets/churrasco4.webp", import.meta.url).href,
        ],
      },
      {
        id: 3,
        ...
        overlay: "MIXOLOGIA",
        images: [
          new URL("./assets/img-coquetel1.webp", import.meta.url).href,
          new URL("./assets/img-coquetel-2.webp", import.meta.url).href,
          new URL("./assets/img-principal-coquetel.webp", import.meta.url).href,
          new URL("./assets/img-coquetel-3.webp", import.meta.url).href,
        ],
      },
      {
        id: 4,
        ...
        images: [
          new URL("./assets/img-principal-culinaria.webp", import.meta.url)
            .href,
          new URL("./assets/img-petisco-2.webp", import.meta.url).href,
          new URL("./assets/img-petiscos-4.webp", import.meta.url).href,
          new URL("./assets/img-petiscos-3.webp", import.meta.url).href,
        ],
      },
    ];
